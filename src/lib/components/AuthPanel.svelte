...
<section class="relative isolate flex min-h-dvh flex-col overflow-hidden">
	...
	>
		<div class="grid gap-8 lg:grid-cols-[1fr_380px] lg:items-end">
			<div
				class="pointer-events-auto relative isolate overflow-hidden border-2 border-[var(--ink)] bg-[var(--panel)] p-6"
			>
				<div
					class="absolute -inset-2 -z-10 bg-[image:url('/auth-panel-background-20260515-112709.png')] bg-cover bg-center opacity-90 blur-[1px]"
					aria-hidden="true"
				></div>
				<div class="absolute inset-0 -z-10 bg-[var(--panel)]/55" aria-hidden="true"></div>

				<div class="relative">
					<p class="text-xs font-black tracking-[0.3em] text-[var(--hot)] uppercase">QckPages</p>
					<h1
						class="mt-5 max-w-3xl text-5xl leading-[0.95] font-black text-[var(--ink)] md:text-7xl"
					>
			...
			<div
				class="pointer-events-auto relative isolate overflow-hidden border-2 border-[var(--ink)] bg-[var(--panel)] p-5"
			>
				<div
					class="absolute -inset-2 -z-10 bg-[image:url('/auth-panel-background-20260515-112709.png')] bg-cover bg-center opacity-90 blur-[1px]"
					aria-hidden="true"
